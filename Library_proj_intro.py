...
ClgLab = Label(nit,text="School : ",font = ("Georgia", 13 ,'bold') ,bg = '#D6D1AE' )
ClgLab.place(x=10,y=80)

ClgLabval = Label(nit,text="New Horizon Scholar School",font = ("Georgia", 13 ,'bold') ,bg = '#D6D4AE',fg='red' )
ClgLabval.place(x=90,y=80)

skLab = Label(nit,text="Project : ",font = ("Georgia", 13 ,'bold') ,bg = '#D6D1AE' )
skLab.place(x=10,y=150)

skLabval = Label(nit,text="CBSE Project : 2024-25 ",font = ("Georgia", 13 ,'bold') ,bg = '#D6D1AE',fg='red' )
...
#
GpMemLab = Label(nit,text="Aditya Mishra",font = ("Georgia", 12 ,'bold') ,bg = '#D6D1AE',fg='red' )
